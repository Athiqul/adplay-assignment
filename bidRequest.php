...
return '{
    ...
    "app": {
        ...
        "publisher": {"id": "pub-5742233882270312", "ext": {"country": "GB"}},
        "content": {
    ...
    "device": {
        ...
        "ip": "103.92.152.0",
        "geo": {"lat": 23.774545669555664, "lon": 90.440811157226562, "country": "BGD", "city": "Dhaka", "zip": "1212"},
        "make": "xiaomi",
        "model": "m2004j19c",
        "os": "android",
        "osv": "11",
    ...
    "user": {"id": "CAESEK7QRNHvCqCtWwFtkJjMQVU", "ext": {}},
    "at": 1,
    "tmax": 1000,
    "cur": ["USD"],
    "bcat": ["IAB1-2"],
